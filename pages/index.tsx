      ...
      <Head><title>Senai + Parceiros</title></Head>
        <main>
          <section id="home" className={styles.sectionContainer}>
            ...
            <strong> SENAI TO</strong> e seus futuros parceiros, apresentar as diretrizes e modelos para consecução de novas parcerias, bem 
            ...
            <br />
            <p>O <strong>SENAI TO</strong> já consolidou mais de 150 parcerias em diversas áreas tecnológicas, contemplando mais de 34 mil
          ...
          <section className={styles.sectionContainer}>
            ...
            <br />
            <p>O <strong>SENAI TO</strong> estabelece suas parcerias por meio de modelos de negócios que estabelecem contrapartidas, 
          ...
          <section className={styles.sectionContainer}>
            ...
            <br />
            <p>Caso sua empresa esteja interessada em se tornar uma parceria do <strong>SENAI TO</strong></p>
            <br />
            <Form />
          </section>
        </main>      
